...
contract UIDataProvider {
        ...
        returns (UserOCData memory userOcData_)
    {
        ...
        // denominator
        int256 denominator_ = int256(totalSupplyInEth_) -
            int256(totalBorrowInEth_);
        ...
        returns (NftData memory nftData_)
    {
        ...
        // denominator
        int256 denominator_ = int256(totalSupplyInEth_) +
            int256(totalHoldInEth_) +
            int256(totalAaveSupplyInEth_) -
            int256(totalBorrowInEth_) -
            int256(totalAaveBorrowInEth_);
        ...
        nftData_.aaveNetApy = denominator_ == 0
            ? int256(0)
            : numerator_ / denominator_;
