...
async function main() {
  ...
  const uiDataProviderAddr = "0x4483286918e9ad10dE97a5eA25e0997c117D6d2b"
  ...
  // const UIDataProvider = await ethers.getContractAt("UIDataProvider", uiDataProviderAddr);
  // let data = await UIDataProvider.getUserOCData('0xa9061100d29C3C562a2e2421eb035741C1b42137');
